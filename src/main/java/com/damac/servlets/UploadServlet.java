	...
	protected void doPost(HttpServletRequest request,
		...
		try{
			if(processName.toLowerCase().equals("aopt")){
				...
				TestAopt.test(savePath+File.separator + fileName, savePath+File.separator + fileOutName);
			}
			else if(processName.toLowerCase().equals("cocd")){
				fileOutName = "cocd_tests_out_demo.xlsx";
				TestCocd.test(savePath+File.separator + fileName, savePath+File.separator + fileOutName);
			}
			else if(processName.toLowerCase().equals("assignment")){
				fileOutName = "assignment_tests_out_demo.xlsx";
				TestAssignment.test(savePath+File.separator + fileName, savePath+File.separator + fileOutName);
			}
		}
		catch(Exception e){
			
		}
		request.setAttribute("fileName", fileOutName);
