...
public class AdditionalParking implements java.io.Serializable{
	...
	private java.lang.String typeofParking;
	private int numberOfParkingRequired;
	private int numberOfParkingAlreadyGiven;
	private double priceOfParking;
	private double priceBelowStandardPrice;
	private double pricePercentageBelowStandardPrice;
	private int requiredDiscountOnParking;
	private boolean eho;
	private boolean ho;
	...
	private java.lang.String documentRequiredOne;
	private java.lang.String documentRequiredTwo;
	private java.lang.String documentRequiredThree;
	...
	public java.lang.String getTypeofParking() {
		return typeofParking;
	}

	public void setTypeofParking(java.lang.String typeofParking) {
		this.typeofParking = typeofParking;
	}

	public int getNumberOfParkingRequired() {
		return numberOfParkingRequired;
	}

	public void setNumberOfParkingRequired(int numberOfParkingRequired) {
		this.numberOfParkingRequired = numberOfParkingRequired;
	}

	public int getNumberOfParkingAlreadyGiven() {
		return numberOfParkingAlreadyGiven;
	}

	public void setNumberOfParkingAlreadyGiven(int numberOfParkingAlreadyGiven) {
		this.numberOfParkingAlreadyGiven = numberOfParkingAlreadyGiven;
	}

	public double getPriceOfParking() {
		return priceOfParking;
	}

	public void setPriceOfParking(double priceOfParking) {
		this.priceOfParking = priceOfParking;
	}

	public double getPriceBelowStandardPrice() {
		return priceBelowStandardPrice;
	}

	public void setPriceBelowStandardPrice(double priceBelowStandardPrice) {
		this.priceBelowStandardPrice = priceBelowStandardPrice;
	}

	public double getPricePercentageBelowStandardPrice() {
		return pricePercentageBelowStandardPrice;
	}

	public void setPricePercentageBelowStandardPrice(double pricePercentageBelowStandardPrice) {
		this.pricePercentageBelowStandardPrice = pricePercentageBelowStandardPrice;
	}

	public int getRequiredDiscountOnParking() {
		return requiredDiscountOnParking;
	}

	public void setRequiredDiscountOnParking(int requiredDiscountOnParking) {
		this.requiredDiscountOnParking = requiredDiscountOnParking;
	}
	...
	public java.lang.String getDocumentRequiredOne() {
		return documentRequiredOne;
	}

	public void setDocumentRequiredOne(java.lang.String documentRequiredOne) {
		this.documentRequiredOne = documentRequiredOne;
	}

	public java.lang.String getDocumentRequiredTwo() {
		return documentRequiredTwo;
	}

	public void setDocumentRequiredTwo(java.lang.String documentRequiredTwo) {
		this.documentRequiredTwo = documentRequiredTwo;
	}

	public java.lang.String getDocumentRequiredThree() {
		return documentRequiredThree;
	}

	public void setDocumentRequiredThree(java.lang.String documentRequiredThree) {
		this.documentRequiredThree = documentRequiredThree;
	}

	public AdditionalParking(java.lang.String description, java.util.Date ruleValidityStart, java.util.Date ruleValidityEnd, java.lang.String processName,
			java.lang.String subProcessName, java.lang.String sourceofRequest, java.lang.String projectCity, java.lang.String project, java.lang.String buildingCode,
			java.lang.String bedroomType, java.lang.String unitType, java.lang.String permittedUse, java.lang.String units, java.lang.String readyOffPlan,
			java.lang.String typeofParking, int numberOfParkingRequired, int numberOfParkingAlreadyGiven, double priceOfParking,
			double priceBelowStandardPrice, double pricePercentageBelowStandardPrice, int requiredDiscountOnParking,
			boolean eho, boolean ho, java.lang.String customerClassification, boolean bulk, int portfolioValue,
			boolean defaultVal, java.lang.String agreementStatus, boolean overdue, boolean ftlSent, boolean dispute,
			boolean enforcement, boolean litigation, boolean mortgage, boolean courtCase, java.lang.String allowed,
			java.lang.String message, java.lang.String recommendingAuthorityOne, java.lang.String recommendingAuthorityTwo,
			java.lang.String recommendingAuthorityThree, java.lang.String recommendingAuthorityFour, java.lang.String approvingAuthorityOne,
			java.lang.String approvingAuthorityTwo, java.lang.String approvingAuthorityThree, java.lang.String adminFeePsf, java.lang.String adminFeeFlat,
			java.lang.String adminFeePercentage, java.lang.String documentRequiredOne, java.lang.String documentRequiredTwo,
			java.lang.String documentRequiredThree) {
		super();
		this.description = description;
		this.ruleValidityStart = ruleValidityStart;
		this.ruleValidityEnd = ruleValidityEnd;
